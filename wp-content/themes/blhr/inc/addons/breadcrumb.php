...
function breadcrumb_display ()
{
    ...
    $breadcrumb_trail->opt['home_title'] = __('Start', 'breadcrumb_navxt');
    $breadcrumb_trail->opt['separator'] = '<span class="separator">&raquo;</span>';
...
class bcn_breadcrumb_trail
{
    ...
    function bcn_breadcrumb_trail()
    {
        ...
        (
            ...
            'home_title' => __('Home', 'breadcrumb_navxt'),
            ...
            'search_prefix' => __('Suchergebnisse für &#39;', 'breadcrumb_navxt'),
            ...
            'archive_category_prefix' => __('', 'breadcrumb_navxt'),
            ...
            'archive_post_tag_prefix' => __('', 'breadcrumb_navxt'),
